            ...
            <>
              <div className="left">
                ...
                <div className="mainImg">
                  <img src={  process.env.REACT_APP_UPLOAD_URL + data?.attributes[selectedImg]?.data?.attributes?.url} alt="selectedImg" />
                </div>
              </div>
              <div className="right">
                ...
                <button className="add" onClick={() => handleAddCart(data)}>
